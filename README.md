...
## 鸣谢
- V1.0灵感来源于利器「liqi.io」,现在已不再更新；
- Markdown格式来源于 Github@[pseudoyu](https://github.com/pseudoyu)/**[yu-tools](https://github.com/pseudoyu/yu-tools)**，此前使用 Notion 记录，但维护对我来说太高，简单点才能更持久😁
...
- **WeChat**，仅用于国内聊天，略厌恶
- **腾讯会议**，工作用，主要会议工具
- **Texts**，一个可以聚合多个平台的即时通讯管理工具
- **飞书**，国内办公的天花板

### 🌏 浏览器

> 主力浏览器 `Brave `，基于 Chrome 内核
- ~~**Arc**，号称跨时代浏览器，内测挺新奇，不能同步书签是硬伤，暂时弃用~~
